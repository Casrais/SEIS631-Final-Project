...
PDMelted <- pivot_longer(PDClean, cols=c(
  "E1", 
  "E2", 
  "E3", 
  "E4",
...
PopUS <- subset.data.frame(PDMelted, PDMelted$country == "US" && PDMelted$age > 0 && PDMelted$age < 100)


```

```{r, echo=FALSE}
ExUS <- subset.data.frame(PopUS, name == "E1" || name == "E2" || name == "E3" || name == "E4" || name == "E5" || name == "E6" || name == "E7" || name == "E8" || name == "E9" || name == "E10")



ggplot(ExUS, aes(x=age, y=value)) + geom_point(data = ExUS, mapping = aes(x=age, y=value), alpha=.01) + xlim(10, 100)

```
looking at the above graph of age versus extroversion, it seems there is little relation between age and being introverted or extroverted with the exception of after age 60 it appears like less people are strongly introverted. 
