...
ggplot(PDClean, aes(x=age, y=Extraversion)) + geom_point(data = PDClean, mapping = aes(x=age, y=Extraversion), alpha=.1, color="red") + xlim(10, 100)

ggplot(PDClean, aes(x=age, y=Openness)) + geom_point(data = PDClean, mapping = aes(x=age, y=Openness), alpha=.1, color="blue") + xlim(10, 100)

ggplot(PDClean, aes(x=age, y=Conscientiousness)) + geom_point(data = PDClean, mapping = aes(x=age, y=Conscientiousness), alpha=.1, color="green") + xlim(10, 100)

ggplot(PDClean, aes(x=age, y=Neuroticism)) + geom_point(data = PDClean, mapping = aes(x=age, y=Neuroticism), alpha=.1, color="purple") + xlim(10, 100)

ggplot(PDClean, aes(x=age, y=Agreeableness)) + geom_point(data = PDClean, mapping = aes(x=age, y=Agreeableness), alpha=.1, color="orange") + xlim(10, 100)
```
...
PDGender$ACavg <- (PDGender$agreeableness+PDGender$extroversion)/2

ggplot(PDGender, aes(x=ACavg, y=extroversion)) + geom_point(data = PDGender, mapping = aes(x=ACavg, y=extroversion), alpha=.1, color="red") + xlim(0, 5) +
    ggtitle("Agreeableness and Conscientiousness Average relationship with Extroversion Scatter Plot") +
    xlab("")

ggplot(PDGender, aes(x=ACavg, y=neuroticism)) + geom_point(data = PDGender, mapping = aes(x=ACavg, y=neuroticism), alpha=.1, color="purple") + xlim(0, 5) +
    ggtitle("Agreeableness and Conscientiousness Average relationship with Neuroticism Scatter Plot") +
    xlab("")

ggplot(PDGender, aes(x=ACavg, y=openness)) + geom_point(data = PDGender, mapping = aes(x=ACavg, y=openness), alpha=.1, color="blue") + xlim(0, 5) +
...
ggplot(PDGender, aes(x=agreeableness, y=extroversion)) + geom_point(data = PDGender, mapping = aes(x=agreeableness, y=extroversion), alpha=.1, color="red") + xlim(0, 5) +
    ggtitle("Agreeableness and Conscientiousness Average relationship with Extroversion Scatter Plot") +
    xlab("")

ggplot(PDGender, aes(x=conscientiousness, y=extroversion)) + geom_point(data = PDGender, mapping = aes(x=conscientiousness, y=extroversion), alpha=.1, color="red") + xlim(0, 5) +
    ggtitle("Agreeableness and Conscientiousness Average relationship with Extroversion Scatter Plot") +
    xlab("")
